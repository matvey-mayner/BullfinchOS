...
local repositoryURL = "https://raw.githubusercontent.com/matvey-mayner/BullfinchOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/bullfinchOS installer/"
...
local function title()
  ...
  centrizedText(y, 0x2D2D2D, "bullfinchOS")
...
local installerMenu = menu:addContextMenuItem("bullfinchOS", 0x2D2D2D)
...
addStage(function()
  ...
  if not selectedFilesystemProxy.getLabel() then
    selectedFilesystemProxy.setLabel("bullfinchOS HDD")
  end
  ...
  component.invoke(EEPROMAddress, "setLabel", "bullfinch EFI")
