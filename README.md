...
-   Integrated application and library App Market with the ability to publish your own scripts and programs for every BullfinchOS user
...
The easiest way is to use default **wget** script. Insert an OpenOS floppy disk and an Internet Card into the computer, turn it on and type the following command to console to install BullfinchOS:

	wget -f https://raw.githubusercontent.com/matvey-mayner/BullfinchOS/master/Installer/BIOS.lua /tmp/bios.lua && flash -q /tmp/bios.lua && reboot
